...
router.get('/stats', function(req, res, next) {
  res.sendFile('/Users/veaf/Saved Games/private_server/Slmod/SlmodStats.json', { root: '' });
});

router.get('/metastats', function(req, res, next) {
  res.sendFile('/Users/veaf/Saved Games/private_server/Slmod/SlmodMetaStats.json', { root: '' });
});
